...
public class CandidateView extends JPanel {
    ...
    private JPanel createActionPanel() {
        ...
        addButton.setIcon(loadIcon("/icon/plus.png", ICON_SIZE));
    ...
    private void setupActionColumns() {
        ImageIcon eyeIcon = loadIcon("/icon/eye.png", ICON_SIZE, false);
        ImageIcon editIcon = loadIcon("/icon/pencil.png", ICON_SIZE, false);
        ImageIcon deleteIcon = loadIcon("/icon/circle-x.png", ICON_SIZE, false);
