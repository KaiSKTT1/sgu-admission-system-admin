...
public class DiemCongXetTuyenView extends JPanel {
    ...
    private DiemCongXetTuyenController controller;

    public DiemCongXetTuyenView() {
    ...
    private JPanel createActionPanel() {
        ...
        addButton.setToolTipText("Thêm điểm cộng");
        addButton.setIcon(tintIcon(loadIcon("/icon/plus.png", ICON_SIZE), Color.BLACK));

        importButton.addActionListener(event -> runWithController(DiemCongXetTuyenController::onImport));
        refreshButton.addActionListener(event -> runWithController(DiemCongXetTuyenController::onRefresh));
        addButton.addActionListener(event -> runWithController(DiemCongXetTuyenController::onAdd));
    ...
    public void setController(DiemCongXetTuyenController controller) {
    ...
    private void runWithController(java.util.function.Consumer<DiemCongXetTuyenController> action) {
        if (controller != null) {
