...
public class ToHopMonThiView extends JPanel {
    ...
    private ToHopMonThiController controller;

    public ToHopMonThiView() {
    ...
    private SearchPanel createSearchPanel() {
        return new SearchPanel("Tìm tổ hợp:", 22, () -> runWithController(ToHopMonThiController::onSearch));
    }
    ...
    private JPanel createActionPanel() {
        ...
        addButton.setToolTipText("Thêm tổ hợp môn thi");
        addButton.setIcon(tintIcon(loadIcon("/icon/plus.png", ICON_SIZE), Color.BLACK));

        importButton.addActionListener(event -> runWithController(ToHopMonThiController::onImport));
        refreshButton.addActionListener(event -> runWithController(ToHopMonThiController::onRefresh));
        addButton.addActionListener(event -> runWithController(ToHopMonThiController::onAdd));
    ...
    public void setController(ToHopMonThiController controller) {
    ...
    private void runWithController(java.util.function.Consumer<ToHopMonThiController> action) {
        if (controller != null) {
