...
public class BangQuyDoiView extends JPanel {
    ...
    private BangQuyDoiController controller;

    public BangQuyDoiView() {
    ...
    private SearchPanel createSearchPanel() {
        return new SearchPanel("Tìm quy đổi:", 22, () -> runWithController(BangQuyDoiController::onSearch));
    }
    ...
    private JPanel createActionPanel() {
        ...
        addButton.setToolTipText("Thêm quy đổi");
        addButton.setIcon(tintIcon(loadIcon("/icon/plus.png", ICON_SIZE), Color.BLACK));

        importButton.addActionListener(event -> runWithController(BangQuyDoiController::onImport));
        refreshButton.addActionListener(event -> runWithController(BangQuyDoiController::onRefresh));
        addButton.addActionListener(event -> runWithController(BangQuyDoiController::onAdd));
    ...
    public void setController(BangQuyDoiController controller) {
    ...
    private void runWithController(java.util.function.Consumer<BangQuyDoiController> action) {
        if (controller != null) {
