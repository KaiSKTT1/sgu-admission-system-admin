...
public class DashboardView extends JPanel {
    ...
    private void setupActionColumns() {
        ImageIcon eyeIcon = loadIcon("/icon/eye.png", ICON_SIZE);
        ImageIcon editIcon = loadIcon("/icon/pencil.png", ICON_SIZE);
        ImageIcon deleteIcon = loadIcon("/icon/circle-x.png", ICON_SIZE);
